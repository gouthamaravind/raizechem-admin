...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Dealer Closure", url: "/finance/dealer-closure", icon: Lock },
    ],
  },
  {
    label: "Reports",
    module: "reports",
    items: [
      { title: "Reports Hub", url: "/reports", icon: LayoutGrid },
      { title: "Cash / Bank Book", url: "/reports/cash-bank-book", icon: Wallet },
      { title: "Group Summary", url: "/reports/group-summary", icon: Layers },
      { title: "Group Vouchers", url: "/reports/group-vouchers", icon: FileText },
      { title: "Contra Register", url: "/reports/contra-register", icon: ArrowLeftRight },
      { title: "Payment Register", url: "/reports/payment-register", icon: ArrowUpFromLine },
      { title: "Receipt Register", url: "/reports/receipt-register", icon: ArrowDownToLine },
      ...
      { title: "Journal Register", url: "/reports/journal-register", icon: ScrollText },
      { title: "Credit Note Register", url: "/reports/credit-note-register", icon: FilePlus },
      { title: "Debit Note Register", url: "/reports/debit-note-register", icon: FileMinus },
